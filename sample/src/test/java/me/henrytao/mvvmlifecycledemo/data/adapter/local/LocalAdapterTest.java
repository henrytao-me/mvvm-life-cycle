...
public class LocalAdapterTest extends BaseTest {
  ...
  public void testActiveTaskError() throws Exception {
    doReturn(null).when(mLocalAdapter).findTask(any());

    mLocalAdapter.activeTask("taskId");
  }

  @Test
  public void testActiveTaskSuccess() throws Exception {
    Task task = new Task("title", "description");
    doReturn(task).when(mLocalAdapter).findTask("taskId");
