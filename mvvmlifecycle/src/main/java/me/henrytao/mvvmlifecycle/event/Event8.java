...
public class Event8<T1, T2, T3, T4, T5, T6, T7, T8> implements Event {
  ...
  private final Listener<T1, T2, T3, T4, T5, T6, T7, T8> mListener;

  public Event8(Listener<T1, T2, T3, T4, T5, T6, T7, T8> listener) {
    mListener = listener;
  }
  ...
  public interface Listener<T1, T2, T3, T4, T5, T6, T7, T8> {

    void onEventTrigger(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8);
  }
}
