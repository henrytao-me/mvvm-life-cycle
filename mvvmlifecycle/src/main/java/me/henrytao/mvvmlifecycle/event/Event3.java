...
public class Event3<T1, T2, T3> implements Event {
  ...
  private final Listener<T1, T2, T3> mListener;

  public Event3(Listener<T1, T2, T3> listener) {
    mListener = listener;
  }
  ...
  public void call(Object o) {
    if (mListener != null && o instanceof Object[]) {
      ...
      if (objects.length == LENGTH) {
        mListener.onEventTrigger((T1) objects[0], (T2) objects[1], (T3) objects[2]);
        return;
      }
  ...
  public interface Listener<T1, T2, T3> {
    ...
    void onEventTrigger(T1 t1, T2 t2, T3 t3);
  }
}
