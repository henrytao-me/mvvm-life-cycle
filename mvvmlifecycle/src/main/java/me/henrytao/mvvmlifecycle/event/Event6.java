...
public class Event6<T1, T2, T3, T4, T5, T6> implements Event {
  ...
  private final Listener<T1, T2, T3, T4, T5, T6> mListener;

  public Event6(Listener<T1, T2, T3, T4, T5, T6> listener) {
    mListener = listener;
  }
  ...
  public interface Listener<T1, T2, T3, T4, T5, T6> {

    void onEventTrigger(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6);
  }
}
